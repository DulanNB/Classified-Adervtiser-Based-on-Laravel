                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c"
                                                                style="font-size:0" align="left">
                                                                <a href="https://dogs.lk" target="_blank">
                                                                    <img src="https://dogsfront.dogs.lk/images/my_imgs/logoA.png" alt="Nalaka.lk"
                                                                         title="Nalaka.lk" width="150px">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-button es-p15t es-p10b" align="center">
                                                                 <span class="es-button-border"
                                                                       style="border-radius: 5px; background: #00bd56 none repeat scroll 0% 0%; border-style: solid; border-color: #2cb543; border-top: 0px solid #2cb543; border-bottom: 0px solid #2cb543;">
                                                                     <a href="https://Nalaka.lk/"
                                                                        class="es-button"
                                                                        target="_blank"
                                                                        style="font-size: 16px; border-top-width: 10px; border-bottom-width: 10px; border-radius: 5px; background: #00bd56 none repeat scroll 0% 0%; border-color: #00bd56;">
                                                                         Visit Nalaka.lk
                                                                     </a>
                                                                 </span>
                                                            </td>
                                        ...
                                        <table cellspacing="0" cellpadding="0" align="center">
                                            ...
                                            <tr>
                                                <td class="es-m-p20b esd-container-frame" width="280" align="left">
                                                    <table style="background-color: #fef9ef; border-color: #efefef; width: 500px; border-collapse: separate; border-width: 1px 0px 1px 1px; border-style: solid;"
                                                           width="100%" cellspacing="0" cellpadding="0"
                                                           bgcolor="#fef9ef">
                                                        <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="esd-block-text es-p20b es-p20r es-p20l"
                                                                ...
                                                                <table style="width: 100%;" class="cke_show_border"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">Name  </span>
                                                                            </td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">{{$name}}</span>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">Subject </span>
                                                                            </td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">{{$subject}}</span>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">DETAILS </span>
                                                                            </td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">{{$msg}}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">Email </span>
                                                                            </td>
                                                                            <td>:</td>
                                                                            <td>
                                                                                <span style="font-size: 14px; line-height: 150%;">{{$email}}</span>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-m-p0l es-m-txt-c"
                                                                ...
                                                                <a href target="_blank">
                                                                    <img src=""
                                                                         alt="Nalaka.lk" title="Dogs.lk" width="108"></a>
                                                            </td>
                                                        </tr>

                                                        <tr>
                                                            <td class="esd-block-text es-p5t es-m-txt-c" align="left">
                                                                <p><a href="tel:94703111111">+94 70 311 1111</a><br><br>
                                                                    <a target="_blank" href="mailto:info@dogs.lk">nalaka@nalaka.lk</a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-c" align="left">
                                                                <p>Nalaka has specialized in stationary services, products,
                                                                    and has different categories related to stationaries. <br>
                                                                </p>
                                                            ...
                                                            <td class="esd-block-text es-p10t es-m-txt-c" align="left">
                                                                <p style="line-height: 150%; font-size: 12px;">
                                                                    <a target="_blank"
                                                                       ...
                                                                       class="unsubscribe">Facebook</a>
                                                                    ♦ <a target="_blank" href=""
                                                                         style="font-size: 12px;">Pinterest</a>
                                                                    ♦ <a target="_blank" href=""
                                                                         style="font-size: 12px;">Instagram</a></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                            ...
                            <table class="es-content-body" style="background-color: transparent;" width="600"
                                ...
                                <tr>
                                    <p class="copyright">
                                        ...
                                        All rights reserved by <a href="https://Nalaka.lk">Nalaka.lk</a> |
