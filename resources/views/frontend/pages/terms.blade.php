...
@section('main-content')
    ...
    <section id="privacy_policy-us" class="ftco-section bg-light ftco-faqs">
        <div class="col-lg-12 col-12">
            <div class="container">
                <h2 class="mb-3"><b>Terms & Conditions</b></h2>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            <br>
                            <h5><b>AGREEMENT TO TERMS </b></h5>
                            <br>
                            <p style="text-align: justify;">
                                These Terms and Conditions constitute a legally binding agreement made between you,
                                whether personally or on behalf of an entity (“you”) and [business entity name] (“we,”
                                “us” or “our”), concerning your access to and use of the [website name.com] website as
                                ...
                                of and to have accepted, the changes in any revised Terms and Conditions by your
                    ...
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            ...
                            <p style="text-align: justify;">
                                ...
                                intellectual property rights and unfair competition laws of Sri Lanka.
                                <br>
                                <br>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            <br>
                            <h5><b>USER REPRESENTATIONS </b></h5>
                            <br>
                            <p style="text-align: justify;">
                            ...
                            <ol>
                                ...
                                <li class="terms">
                                    Assist law enforcement and respond to subpoena.(2) you will maintain the accuracy of
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            <br>
                            <h5><b>COPYRIGHT INFRINGEMENTS </b></h5>
                            <br>
                            <p style="text-align: justify;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            <br>
                            <h5><b>TERM AND TERMINATION </b></h5>
                            <br>
                            <p style="text-align: justify;">
                                ...
                                TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF
                                THE SITE (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR
                                NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR
                                COVENANT CONTAINED IN THESE TERMS AND CONDITIONS OR OF ANY APPLICABLE LAW OR REGULATION.
                                WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE [YOUR ACCOUNT AND] ANY
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            <br>
                            <h5><b>MODIFICATIONS AND INTERRUPTIONS </b></h5>
                            <br>
                            <p style="text-align: justify;">
                    ...
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            ...
                            <p style="text-align: justify;">
                                ...
                                accordance with the laws of Sri Lanka applicable to agreements made and to be entirely
                                performed within the country, without regard to its conflict of law principles.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            <br>
                            <h5><b>CORRECTIONS </b></h5>
                            <br>
                            <p style="text-align: justify;">
                                There may be information on the Site that contains typographical errors, inaccuracies,
                                or omissions that may relate to the Site, including descriptions, pricing, availability,
                    ...
                    <div class="col-lg-12">
                        <div class="heading-section mb-5 mt-5 mt-lg-0">
                            ...
                            <p style="text-align: justify;">
                                ...
                                Terms and Conditions and the lack of signing by the parties hereto to execute these
